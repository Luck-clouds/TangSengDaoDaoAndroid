...
public interface RtcApiService {
    ...
    Observable<CommonResponse> rejectCall(@Path("call_id") String callId, @Body JSONObject body);

    @POST("rtc/calls/{call_id}/cancel")
    Observable<CommonResponse> cancelCall(@Path("call_id") String callId, @Body JSONObject body);

    @POST("rtc/calls/{call_id}/close")
    Observable<CommonResponse> closeCall(@Path("call_id") String callId, @Body JSONObject body);

    @POST("rtc/calls/{call_id}/leave")
    Observable<CommonResponse> leaveCall(@Path("call_id") String callId, @Body JSONObject body);

    @POST("rtc/calls/{call_id}/invite")
    Observable<CommonResponse> inviteMembers(@Path("call_id") String callId, @Body JSONObject body);
