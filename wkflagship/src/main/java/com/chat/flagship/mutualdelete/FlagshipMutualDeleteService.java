...
public interface FlagshipMutualDeleteService {
    ...
    @HTTP(method = "DELETE", path = "message/mutual/batch", hasBody = true)
    Observable<CommonResponse> batchMutualDelete(@Body List<FlagshipMutualDeleteRequest> requestList);
}
